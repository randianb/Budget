<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OAAnnSpendAnaly.aspx.cs" Inherits="WebPage_OptAnaly_OAAnnSpendAnaly" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Panel ID="Panel1" runat="server" Height="80" Title="自选分析-选择年度数据" Layout="HBoxLayout">
            <Items>
