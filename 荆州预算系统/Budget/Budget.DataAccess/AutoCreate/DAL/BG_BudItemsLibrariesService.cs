...
namespace BudgetWeb.DAL
{
	public static partial class BG_BudItemsLibrariesService
	{
		...
		{
            string sql =
				"INSERT BG_BudItemsLibraries (BILProType, BILFunSub, PPID, PIID, BILAttr, BILAppReaCon, BILExpGistExp, BILLongGoal, BILYearGoal, BILMon, BILMonSou, BILFinAllo, BILLastYearCarry, BILOthFun, BILOthExpProb, DepID, BILProName, BILProDescrip, BILProCategory, BILPlanHz)" +
				"VALUES (@BILProType, @BILFunSub, @PPID, @PIID, @BILAttr, @BILAppReaCon, @BILExpGistExp, @BILLongGoal, @BILYearGoal, @BILMon, @BILMonSou, @BILFinAllo, @BILLastYearCarry, @BILOthFun, @BILOthExpProb, @DepID, @BILProName, @BILProDescrip, @BILProCategory, @BILPlanHz)";
            ...
            try
            {
				SqlParameter[] para = new SqlParameter[]
				{
					...
					new SqlParameter("@BILPlanHz", bG_BudItemsLibraries.BILPlanHz)
				};
        ...
        public static BG_BudItemsLibraries GetBG_BudItemsLibrariesByBudItID(int budItID)
        {
            ...
            try
            {
                ...
                if(dt.Rows.Count > 0)
                {
                    ...
                    bG_BudItemsLibraries.BILPlanHz = dt.Rows[0]["BILPlanHz"] == DBNull.Value ? "" : (string)dt.Rows[0]["BILPlanHz"];
