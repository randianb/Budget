...
namespace BudgetWeb.DAL
{
    public class BGBudItemsLibrariesService
    {
        ...
        internal static DataTable GetExamineBG_BudItemsLibrariesByDept(int depid, int year)
        {
            DataTable dt = new DataTable();
            try
            {
                string sqlStr = "select * from BG_BudItems where DepID={0} and  BIYear={1} and BudSta='审核通过' ";
