...
<body style="background: url(img/bg/s1.jpg); margin: 0px; padding: 0px;">
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <span style="font-size: 36px; font-family: 宋体; font-weight: bold; position: absolute; left: 180px; top: 30px;">地税预算管理系统V1.0</span>
            <div style="float: right; width: 580px; height: 90px; background: url(img/bg/s3.jpg); font-size: 12px;">
                ...
                <ul style="list-style: none;">
                  <%--<li class="closepage">
                    ...
                    <li>
                        ...
                        <ext:Label ID="Label2" runat="server" Text="荆州市"></ext:Label>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <asp:Label ID="lbUser" runat="server" Text="" Width="100px" style=" font-size: 12px;" ></asp:Label>
