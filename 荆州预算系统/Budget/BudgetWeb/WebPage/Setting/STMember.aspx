...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <style type="text/css">.lo {position: absolute; left: 15px; top: 610px; }</style>
    ...
    <body>
        <form id="form1" runat="server"> 
            ...
            <ext:ResourceManager ID="ResourceManager1" runat="server" />
              <asp:Button ID="Button1" runat="server" Text="导出人员详细" OnClick="btnPrint" CssClass="lo"/>
                    ...
                    <ext:Panel ID="Panel1" runat="server" Layout="ColumnLayout"> 
                        <Items> 
                            ...
                            <ext:TreePanel
                                ...
                                UseArrows="true"
                                RootVisible="false"
                                ColumnWidth="0.3" Layout="fit" AutoScroll="True"> 
                                <%--<Store>
                            ...
                            <ext:FormPanel ID="PlMenber"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="TextField3" LabelWidth="60"
                                                   ...
                                                   AllowBlank="true"
                                                   ReadOnly="true"
                                                   FieldLabel="登录帐号" Regex="^[A-Za-z0-9]+$" RegexText="必须为英文字母"
                                                   Name="worknum" />
                                    ...
                                    <ext:FieldSet ID="FieldSet1"
                                       ...
                                       <ext:FieldSet ID="FieldSet2"
                                           Hidden="True"
                                                  ...
                                                  DefaultAnchor="100%">
                                           <Items>
                                    <ext:RadioGroup Layout="AnchorLayout" ID="RadioGroup1"   runat="server"   >
<%--                                           <Defaults>--%>
...
<%--                                    </Defaults>--%>
                                    ...
                                    <ext:Container runat="server" MarginSpec="20 0 0 0"></ext:Container>
                                    <ext:Button ID="btnMod"  Width="80" MarginSpec="0 0 0 10" Icon="UserEdit" runat="server" Text="确定">
                                        <Listeners>
                                            <Click Handler="
                                    ...
                                    <ext:Button ID="btnDel"   runat="server" MarginSpec="0 0 0 10" Text=" 删除 " Width="80" Icon="Delete" OnDirectClick="btnDel_DirectClick" />
                                    <ext:Button ID="btninit"   runat="server" MarginSpec="0 0 0 10" Text=" 初始化密码 " Width="100" Icon="Delete" OnDirectClick="btninit_OnDirectClick" />
                                </Items>
                            </ext:FormPanel>
<%--                            <ext:Container ID="Container1" runat="server" ColumnWidth="0.2"></ext:Container>--%>
                        </Items>
                    </ext:Panel>
