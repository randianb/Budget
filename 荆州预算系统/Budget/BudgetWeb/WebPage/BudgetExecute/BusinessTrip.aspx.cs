...
public partial class WebPage_BudgetExecute_BusinessTrip : System.Web.UI.Page
{
    string arid = "0";
    ...
    private void AddBind(string strcon)
    {
        ...
        TextBox33.Text = ConvertSum.ConvertToSum((ParToDecimal.ParToDel(money) * 10000).ToString());
