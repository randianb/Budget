        ...
        function changeStyle() {
            if ($("#gridview-1009 table tr").length > 0) { 
                $("#gridview-1009 table tr").each(function () {
                    if ($(this).find("td:first div").text() == "总计" || $(this).find('td:first div:contains("总金额")').length>0) {
    ...
    <div class="table_list">
        ...
        <ext:Viewport ID="ViewPort1" runat="server" Layout="FitLayout">
            <Items>
                ...
                <ext:GridPanel ColumnLines="true" ID="gridpanel1" runat="server" Layout="FitLayout" AutoScroll="true"
                    Title="查询月度用款计划">
                            ...
                            <Model> 
                                <ext:Model ID="Model1" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="MPFundingAddTimes" Type="string" />
                                    </Fields>
                                </ext:Model>
                            </Model>
                    ...
                    <ColumnModel ID="cmAudit" runat="server" >
                        <Columns> 
                            ...
                            <ext:Column Sortable="true" ID="Column2" runat="server" Text="批次" Flex="1" DataIndex="MPFundingAddTimes" />
                        ...
                        <ext:Toolbar ID="Toolbar1" runat="server" Layout="AnchorLayout" BaseCls="background:transparent">
                            <Items>
                                ...
                                <ext:Panel Border="false" runat="server" Layout="ColumnLayout" MarginSpec="0 0 5 0">
                                 ...
                                 <ext:Panel ID="Panel1"  Border="false" runat="server" Layout="ColumnLayout" MarginSpec="0 0 10 0"  ><Items><ext:Label ID="Label4" runat="server" MarginSpec="5 5 0 5" Text="申请批次：" Width="60"></ext:Label><ext:ComboBox runat="server" ID="cmbpici" ColumnWidth="0.2"><SelectedItems>
                                                                                                                    <ext:ListItem Index="0">
                                                                                                                    </ext:ListItem>
