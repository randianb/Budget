...
public partial class WebPage_BudgetControl_PayIncomeAllocation : BudgetBasePage
{
    ...
    public void HidBind()
    {
        HidtotalMon.Text = getMon(depid, 1000);
        HidtotalMon1.Text= getMon(depid, 1015);
        HidtotalMon2.Text= getMon(depid, 1051);
        HidtotalMon3.Text= getMon(depid, 1065); 
    }
    ...
    private void DtDataBind()
    {
        ...
        BAA.Text = (txt + premon).ToString("f2");
        ...
        {
            SUPP.Text = (ParToDecimal.ParToDel(dt6.Rows[0]["SuppMon"].ToString()) - sutxt).ToString("f2");
        }
...
//    }
    ...
    private string getMon(int Depid,int Piedobid)
    {
        string str = BG_PayIncomeLogic.gettotalMon(Depid, Piedobid);
        return str;
    }
}
