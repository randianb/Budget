        ...
        <ext:Viewport ID="ViewPort1" runat="server"  Layout="fit">
            <Items>
                ...
                <ext:GridPanel ID="gridpanel1" ColumnLines="true" runat="server" Layout="fit" AutoScroll="true"   
                    Title="财务科审核">
                    <Tools><ext:Tool ID="Tool1" runat="server" Type="Prev" ><Listeners><Click Handler="window.location.href ='ControlAudit.aspx?Audit=0'"></Click></Listeners></ext:Tool></Tools>
                    <Store>
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server" Layout="AnchorLayout" BaseCls="background:transparent">
                            <Items>
                                ...
                                <ext:Panel ID="Panel2"  Border="false" runat="server" Layout="ColumnLayout" MarginSpec="0 0 10 0"  ><Items><ext:Label ID="Label4" runat="server" MarginSpec="5 5 0 5" Text="申请批次：" Width="60"></ext:Label><ext:ComboBox runat="server" ID="cmbpici" ColumnWidth="0.2"> <Items>
