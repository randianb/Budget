<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BEPublicExpenseBudget.aspx.cs" Inherits="WebPage_BudgetEstimate_BEPublicExpenseBudget" %>
            ...
            <Items>
                <ext:GridPanel ColumnLines="true"
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            <ext:Column ID="Column1" runat="server" Align="Center" Text="公用经费预算" Flex="1" DataIndex="PSName" />
                            <ext:Column ID="Column2" runat="server" Align="Center" Text="本年度" Flex="1">
                                <Columns>
                                    ...
                                    <ext:SummaryColumn ID="SummaryColumn2" runat="server" Align="Center" Text="人均数" Flex="0" DataIndex="rjsold"></ext:SummaryColumn>
                                </Columns>
                            </ext:Column>
                            <ext:Column ID="Column3" runat="server" Align="Center" Text="下年度" Flex="1">
                                <Columns>
                                    <ext:SummaryColumn ID="SummaryColumn3" runat="server" Align="Center" Text="定额标准（元）" Width="100" DataIndex="StandardQuota"></ext:SummaryColumn>
                                    <ext:SummaryColumn ID="SummaryColumn6" runat="server" Align="Center" Text="定额数（元）" Width="100" DataIndex="StandardQuotacount"></ext:SummaryColumn>
                                    <ext:SummaryColumn ID="Column4" runat="server" Text="测算数" Align="Center" Width="100" DataIndex="PDBaseData">
                                        <Editor>
