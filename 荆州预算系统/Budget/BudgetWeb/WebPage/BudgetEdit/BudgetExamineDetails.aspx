<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BudgetExamineDetails.aspx.cs" Inherits="BudgetPage_mainPages_BudgetExamineDetails" %>
    ...
    <form id="form1" runat="server">
        <div class="table_list">
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                <tr>
                    <td colspan="4" class="tr1">&nbsp;<strong>预算上报</strong>
                ...
                <tr>
                    ...
                    <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtBudConNumber" CssClass="txt" runat="server" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                ...
                <tr>
                    <td align="center" colspan="9">
                        <asp:Button ID="btnExam" runat="server" Text=" 上 报 " CausesValidation="false" CssClass="btns" OnClick="btnExam_Click" />
                        <asp:Button ID="btnReturn" runat="server" Text=" 退 回 " CssClass="btns" ValidationGroup="BackChk" OnClick="btnReturn_Click" />
