<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HislTraDetails.aspx.cs" Inherits="BudgetPage_mainPages_HislTraDetails" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="table_list">
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                <tr>
                    <td colspan="4" class="tr1">&nbsp;<strong>预算详情</strong>
