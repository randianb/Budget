<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BGFixAssetPurchaseAdd.aspx.cs" Inherits="BudgetPage_mainPages_BGFixAssetPurchaseAdd" %>
    ...
    <form id="form1" runat="server">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;
                    <asp:TextBox ID="txtMon" CssClass="txt" Enabled="false" runat="server" ValidationGroup="AddFap"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="金额不能为空" ControlToValidate="txtMon" Display="Dynamic" Enabled="false" ForeColor="Red" ValidationGroup="AddFap"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="txtMon" Display="Dynamic" ErrorMessage="金额必须为数字" ForeColor="Red" MaximumValue="9999999" MinimumValue="0" Type="Double" ValidationGroup="AddFap"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;
                    <asp:TextBox ID="txtTime"  ValidationGroup="AddFap" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'2010-01-01',maxDate:'2020-01-01'})" CssClass="txt" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator  ValidationGroup="AddFap" ID="RequiredFieldValidator10" runat="server" ErrorMessage="请选择时间" ControlToValidate="txtTime" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>&nbsp;&nbsp;
                    <asp:Button ID="btnAdd"  ValidationGroup="AddFap" CssClass="btns" runat="server" Text="添加" OnClick="btnAdd_Click" Height="20px"  />
                    <asp:Button ID="btnCan" CssClass="btns" runat="server" Text="返回" OnClick="btnCan_Click"  />
