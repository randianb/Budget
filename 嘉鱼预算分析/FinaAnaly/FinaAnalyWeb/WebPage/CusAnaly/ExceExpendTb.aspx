<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExceExpendTb.aspx.cs" Inherits="WebPage_CusAnaly_ExceExpendTb" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- 表头开始 -->
        <div class="tabtitle">
            <span>当前位置：<b>定制分析</b>&nbsp;&nbsp;>&nbsp;&nbsp;三公经费支出情况表</span><p>
            </p>
        </div>
        <!-- 表头结束 -->
        <div class="table_list">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: center;">
                <tr>
                    <td colspan="1" class="tr1" align="left">&nbsp;<strong>三公经费支出情况表</strong>
                    </td>
                    <td colspan="4" class="tr1" align="right">&nbsp;<strong>单位：元</strong>
                    </td>
                </tr>
                <tr>
                    <td width="15%" class="tr1" align="center" >项目分类
                     </td>
                    <td width="15%" class="tr1" align="center">市局下达数
                    </td>
                    <td width="15%" class="tr1" align="center" >本月实际支出                        
                     </td>
                    <td width="15%" class="tr1" align="center" >累计实际支出            
                    </td>
                    <td width="15%" class="tr1" align="center" >占下达数比例
                    </td>
                </tr>               
