<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BalanceEvaForm.aspx.cs" Inherits="WebPage_CusAnaly_BalanceEvaForm" %>
...
<body>
    <form id="form1" runat="server">
        <!-- 表头开始 -->
        <div class="tabtitle">
            <span>当前位置：<b>定制分析</b>&nbsp;&nbsp;>&nbsp;&nbsp;资产负债评估表</span><p>
            </p>
        </div>
        <!-- 表头结束 -->
        <div class="table_list">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: center;">
                <tr>
                    <td colspan="19" class="tr1" align="left">&nbsp;<strong>资产负债评估表</strong>
                    </td>
                </tr>
                <tr>
                    <td width="15%" align="center" class="tr1">科目编码
                    </td>
                    <td width="25%" align="center" class="tr1">项目
                    </td>
                    <td width="15%" align="center" class="tr1">期初数
                    </td>
                    <td width="15%" align="center" class="tr1">期末数
                    </td>
