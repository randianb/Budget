<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartUpd.aspx.cs" Inherits="WebPage_SysSetting_DepartUpd" %>
...
<body>
    <form id="form1" runat="server">
        <!-- 表头开始 -->
        <div class="tabtitle">
            <span>当前位置：<b>系统设置</b>&nbsp;&nbsp;>&nbsp;&nbsp;部门设置&nbsp;&nbsp;>&nbsp;&nbsp;部门修改</span><p>
            </p>
        </div>
        <!-- 表头结束 -->
        <div class="table_list">
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 35px;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDepName" CssClass="txt" runat="server" ValidationGroup="DepUpd"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                            ControlToValidate="txtDepName" Display="Dynamic" ErrorMessage="* 部门名称不能为空" ForeColor="Red" ValidationGroup="DepUpd"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
