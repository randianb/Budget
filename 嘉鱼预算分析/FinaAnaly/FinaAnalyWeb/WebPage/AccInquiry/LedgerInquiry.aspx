<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LedgerInquiry.aspx.cs" Inherits="WebPage_AccInquiry_LedgerInquiry" %>
...
<body>
    <form id="form1" runat="server">
        <!-- 表头开始 -->
        <div class="tabtitle">
            <span>当前位置：<b>账表查询</b>&nbsp;&nbsp;>&nbsp;&nbsp;总账查询</span><p>
            </p>
        </div>
        <!-- 表头结束 -->
        <div class="table_list">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 35px;">
                <tr>
                    <td class="tr1" colspan="7">&nbsp;<strong>总账</strong>
                    </td>
                </tr>
                <tr>
                    <td class="tr1" colspan="7">
                ...
                <tr>
                    ...
                    <td width="40%" align="center" class="tr1" rowspan="2">摘要</td>
