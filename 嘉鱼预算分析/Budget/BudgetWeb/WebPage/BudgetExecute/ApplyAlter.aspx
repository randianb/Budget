<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyAlter.aspx.cs" Inherits="BudgetPage_mainPages_ApplyAlter" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="table_list">
            <table border="0" style="line-height: 40px;">
                <tr>
                    <td colspan="2" class="tr1">&nbsp;<strong>申请表修改</strong>
                    </td>
                </tr>
                <%--  <tr>
            ...
            <tr>
                ...
                <tr>
                   ...
                   <asp:TextBox ID="txtreason" CssClass="txt" runat="server" Height="20px" Width="300px"></asp:TextBox><span style="color: red">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtARExcu" Display="Dynamic" ErrorMessage="事由不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <asp:Label ID="lbRDType" runat="server" Text=""></asp:Label>
                        <asp:Button ID="btnAlt" CssClass="btns" runat="server" Text=" 修  改 " OnClick="btnAlter_Click" />
                    </td>
                </tr>
                <tr>
                    <td class="tr1 right">修改附件</td>
                    <td class="auto-style1">&nbsp;&nbsp;
                    <asp:Button ID="btnAlter" CssClass="btns" runat="server" Text=" 确  定 " OnClick="btnAlt_Click" />
