<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditorQuery.aspx.cs" Inherits="mainPages_AuditorQuery" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="table_list">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: center; width:100%; ">
                <tr>
                    <td colspan="6" class="tr1" align="left">&nbsp;<strong>审核员查询列表</strong></td>
                ...
                <td width="11%" class="tr1" align="center">
                    ...
                    <td width="11%" class="tr1" align="center">事由
                    </td>
                    <td class="auto-style1" align="center">申请单状态
                    </td>
                </tr>
