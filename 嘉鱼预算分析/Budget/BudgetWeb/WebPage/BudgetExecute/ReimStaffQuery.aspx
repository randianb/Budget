<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReimStaffQuery.aspx.cs" Inherits="mainPages_ReimStaffQuery" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="table_list">
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 35px;">
                <tr>
                    <td colspan="2" class="tr1">&nbsp;<strong>报账员查询</strong>
                    </td>
                </tr>
                <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: center; width:100%;">
                <tr>
                    <td colspan="7" class="tr1" align="left">&nbsp;<strong>报账员查询列表</strong>
                    </td>
                </tr>
                <tr>
