<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BugHisAddPage.aspx.cs" Inherits="WebPage_BudgetEdit_BugHisAddPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport runat="server" Layout="FitLayout">
            <Items>
                <ext:Panel ID="Panel8" runat="server" Layout="ColumnLayout" AutoScroll="true">
                    <Items>
                        <ext:Panel ID="Panel7" runat="server" ColumnWidth="0.5">
                            <Content>
                                <div class="table_list">
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目类别：
                                            </td>
                                            <td>&nbsp;&nbsp;
                   <asp:DropDownList ID="ddlProType" CssClass="txt" runat="server">
                       ...
                       <asp:ListItem>公费医疗项目</asp:ListItem>
                                            ...
                                            <td width="22%" class="tr1 right">功能科目：
                  ...
                  <asp:DropDownList ID="ddlFunSub" CssClass="txt" runat="server">
                      ...
                      <asp:ListItem Value="其它税收事务支出">其它税收事务支出</asp:ListItem>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目编号：
                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtItemNumber" CssClass="txt" runat="server" ValidationGroup="AddBI" ReadOnly="True"></asp:TextBox><span style="color: red">*</span>
                                            ...
                                            <td width="22%" class="tr1 right">项目名称：
                        ...
                        <asp:TextBox ID="txtProName" runat="server" CssClass="txt" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">行政成本类别：
                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlAdmCostCate" CssClass="txt" runat="server">
                            <asp:ListItem Selected="True">行政单位一般行政管理项目支出</asp:ListItem>
                                            ...
                                            <td width="22%" class="tr1 right">项目安排频度：
                       ...
                       <asp:DropDownList ID="ddlBIPlanHz" CssClass="txt" runat="server">
                           ...
                           <asp:ListItem Value="一次性项目">一次性项目</asp:ListItem>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目起始时间：
                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtBIStaTime" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtBIEndTime\')}'})" CssClass="txt" runat="server" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                            ...
                                            <td width="22%" class="tr1 right">项目终止时间：
                 ...
                 <asp:TextBox ID="txtBIEndTime" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtBIStaTime\')}',maxDate:'2020-01-01'})" runat="server" CssClass="txt" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目负责人：
                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtBICharger" CssClass="txt" runat="server" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                            ...
                                            <td width="22%" class="tr1 right">项目属性：
                        ...
                        <asp:DropDownList ID="ddlProProper" CssClass="txt" runat="server">
                            ...
                            <asp:ListItem>当年项目</asp:ListItem>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目类型：
                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlPayProType" CssClass="txt" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPayProType_SelectedIndexChanged">
                                            ...
                                            <td width="22%" class="tr1 right">预算控制数：
                        ...
                        <asp:TextBox ID="txtBudConNumber" CssClass="txt" runat="server" CausesValidation="false" ReadOnly="True"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目报进日期：
                                            </td>
                        ...
                        <asp:TextBox ID="txtBITime" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" CssClass="txt" runat="server" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                            ...
                                            <td width="22%" class="tr1 right"></td>
                                            <td width="35%">&nbsp;&nbsp;
                        <%--<asp:Button ID="btnSure1" runat="server" Text="项目库" OnClick="btnSure1_Click" />--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目简介：
                        ...
                        <asp:TextBox ID="txtProDesc" runat="server" CssClass="txt" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目申请理由和主要内容：
                        ...
                        <asp:TextBox ID="txtBIAppReaCon" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目支出测算依据及说明：
                        ...
                        <asp:TextBox ID="txtBIExpGistExp" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目绩效长期目标：
                        ...
                        <asp:TextBox ID="txtBILongGoal" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">项目绩效年度目标：
                        ...
                        <asp:TextBox ID="txtBIYearGoal" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                        ...
                                        <tr>
                                            <td width="22%" class="tr1 right">其他说明的问题：
                        ...
                        <ext:Panel ID="Panel9" runat="server" ColumnWidth="0.5">
                            <Content>
                                <div class="table_list">
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;
                     <asp:DropDownList ID="ddlProType1" CssClass="txt" runat="server">
                       <asp:ListItem Selected="True">一般项目</asp:ListItem>
                       <asp:ListItem>一般项目</asp:ListItem>
                       <asp:ListItem>不可预见费项目</asp:ListItem>
                       <asp:ListItem>科技研究与开发项目</asp:ListItem>
                       <asp:ListItem>公费医疗项目</asp:ListItem>
                                            ...
                                            <td width="35%">&nbsp;&nbsp;
                  <asp:DropDownList ID="ddlFunSub1" CssClass="txt" runat="server">
                      <asp:ListItem Value="一般行政管理事务(税收)" Selected="True">一般行政管理事务(税收)</asp:ListItem>
                      <asp:ListItem Value="税务办案">税务办案</asp:ListItem>
                      <asp:ListItem Value="代扣代收代征税款手续费">代扣代收代征税款手续费</asp:ListItem>
                      <asp:ListItem Value="税务宣传">税务宣传</asp:ListItem>
                      ...
                      <asp:ListItem Value="其它税收事务支出">其它税收事务支出</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtItemNumber1" CssClass="txt" runat="server" ValidationGroup="AddBI" ReadOnly="True"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtItemNumber" Display="Dynamic" ErrorMessage="项目编号不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                            <td width="22%" class="tr1 right">项目名称：
                    
                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtProName1" runat="server" CssClass="txt" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtProName" Display="Dynamic" ErrorMessage="项目名称不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">行政成本类别：
                                            ...
                                            <td>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlAdmCostCate1" CssClass="txt" runat="server">
                            <asp:ListItem Selected="True">行政单位一般行政管理项目支出</asp:ListItem>
                        </asp:DropDownList>
                                            </td>
                                            <td width="22%" class="tr1 right">项目安排频度：
                                            ...
                                            <td>&nbsp;&nbsp;
                       <asp:DropDownList ID="ddlBIPlanHz1" CssClass="txt" runat="server">
                           <asp:ListItem Selected="True" Value="常年性项目">常年性项目</asp:ListItem>
                           <asp:ListItem Value="延续性项目"> 续性项目</asp:ListItem>
                           <asp:ListItem Value="一次性项目">一次性项目</asp:ListItem>
                       </asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtBIStaTime1" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtBIEndTime\')}'})" CssClass="txt" runat="server" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtBIStaTime" Display="Dynamic" ErrorMessage="项目起始时间不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                            <td width="22%" class="tr1 right">项目终止时间：
                        
                                            </td>
                                            <td>&nbsp;&nbsp;
                 <asp:TextBox ID="txtBIEndTime1" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtBIStaTime\')}',maxDate:'2020-01-01'})" runat="server" CssClass="txt" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtBIEndTime" Display="Dynamic" ErrorMessage="项目终止时间不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目负责人：
                                            ...
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtBICharger1" CssClass="txt" runat="server" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="txtBICharger" Display="Dynamic" ErrorMessage="项目负责人不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                            <td width="22%" class="tr1 right">项目属性：

                                            </td>
                                            <td>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlProProper1" CssClass="txt" runat="server">
                            <asp:ListItem Selected="True">持续性项目</asp:ListItem>
                            <asp:ListItem>当年项目</asp:ListItem>
                        </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlPayProType1" CssClass="txt" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPayProType_SelectedIndexChanged">
                        </asp:DropDownList>
                                            </td>
                                            <td width="22%" class="tr1 right">预算控制数：
                                            ...
                                            <td>&nbsp;&nbsp;
                        <asp:TextBox ID="txtBudConNumber1" CssClass="txt" runat="server" CausesValidation="false" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目报进日期：
                                            ...
                                            <td class="auto-style1">&nbsp;&nbsp;
                        <asp:TextBox ID="txtBITime1" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" CssClass="txt" runat="server" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txtBITime" Display="Dynamic" ErrorMessage="项目报进日期不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                            <td width="22%" class="tr1 right"></td>
                                            <td width="35%">&nbsp;&nbsp;
                        <asp:Button ID="btnSure1" runat="server" Text="项目库" OnClick="btnSure1_Click" />
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style1" colspan="3">&nbsp;&nbsp;
                        <asp:TextBox ID="txtProDesc1" runat="server" CssClass="txt" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtProDesc" Display="Dynamic" ErrorMessage="项目简介不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目申请理由和主要内容：
                                            ...
                                            <td class="auto-style1" colspan="3">&nbsp;&nbsp;
                        <asp:TextBox ID="txtBIAppReaCon1" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="txtBIAppReaCon1" Display="Dynamic" ErrorMessage="项目申请理由不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目支出测算依据及说明：
                                            ...
                                            <td class="auto-style1" colspan="3">&nbsp;&nbsp;
                        <asp:TextBox ID="txtBIExpGistExp1" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="txtBIExpGistExp" Display="Dynamic" ErrorMessage="项目支出测算依据及说明不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目绩效长期目标：
                                            ...
                                            <td class="auto-style1" colspan="3">&nbsp;&nbsp;
                        <asp:TextBox ID="txtBILongGoal1" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="txtBILongGoal" Display="Dynamic" ErrorMessage="项目绩效长期目标不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">项目绩效年度目标：
                                            ...
                                            <td class="auto-style1" colspan="3">&nbsp;&nbsp;
                        <asp:TextBox ID="txtBIYearGoal1" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="txtBIYearGoal" Display="Dynamic" ErrorMessage="项目绩效年度目标不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="tr1 right">其他说明的问题：
                                            ...
                                            <td class="auto-style1" colspan="3">&nbsp;&nbsp;
                        <asp:TextBox ID="txtBIOthExpProb1" CssClass="txt" runat="server" Width="75%" Height="50px" TextMode="MultiLine" ValidationGroup="AddBI"></asp:TextBox><span style="color: red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="txtBIOthExpProb1" Display="Dynamic" ErrorMessage="其他说明问题不能为空" ForeColor="Red" ValidationGroup="AddBI"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>


                                    <table id="Table1" border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                                        <tr>
                                            <td width="11%" rowspan="3" class="tr1" align="center">行号</td>
                                            <td width="11%" rowspan="3" class="tr1" align="center">当前年度</td>
                                            <td width="11%" rowspan="3" class="tr1" align="center">经济科目</td>
                                        ...
                                        <tr>
                                            <td colspan="9" style="border: 0px;">
                                                <div id="div1" style="border: 0px; margin-left: -12px;">
                                                    <div id="Div2">
                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                            <tr>
                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox9" CssClass="txtJs" name="txt1" Text="1" runat="server" ReadOnly="True"></asp:TextBox>
                                                                </td>

                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox10" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy'})" CssClass="txtJs" name="txt2" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td width="11%">
                                                                    <asp:DropDownList ID="ddlIncome" CssClass="txtJs" name="txt3" runat="server">
                                                                    </asp:DropDownList>
                                                                ...
                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox11" CssClass="txtJs" name="txt4" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                                                </td>
                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox12" CssClass="txtJs" name="txt5" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                                                </td>
                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox13" CssClass="txtJs" name="txt6" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                                                </td>
                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox14" CssClass="txtJs" name="txt7" Text="0" onkeyup="MonSumFn(this);" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td width="11%">
                                                                    <asp:TextBox ID="TextBox15" CssClass="txtJs" name="txt8" Text="0" onkeyup="MonSumFn(this);" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td width="11%" align="center">
                                                                    <input id="Button3" type="button" value="删除" onclick="removeMe(this)" class="btns" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" style="line-height: 28px;">
                                        <tr id="Tr1" style="display: none;">
                                            ...
                                            <td width="11%">
                                                <asp:TextBox ID="TextBox16" CssClass="txtJs" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td width="11%">
                                                <asp:TextBox ID="TextBox17" CssClass="txtJs" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td width="11%">
                                                <asp:TextBox ID="TextBox18" CssClass="txtJs" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td width="11%">
                                                <asp:TextBox ID="TextBox19" CssClass="txtJs" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td width="11%">
                                                <asp:TextBox ID="TextBox20" CssClass="txtJs" runat="server" Text="0" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td width="11%" align="center"></td>
                                        </tr>
                                        <tr></tr>
                    ...
                    <Items>
                        ...
                        <ext:Container ID="Container1" runat="server" Layout="ColumnLayout" PaddingSpec="8 0 0 0">
                            <Items>
                                ...
                                <%--<ext:ComboBox runat="server" ID="cb3" Width="160" DisplayField="PayPrjName"
                                ...
                                <ext:ComboBox ID="cb3"
                                    runat="server"
                                    Width="120" LabelWidth="50" QueryMode="Local" TypeAhead="true" PaddingSpec="0 0 0 15" Hidden="true" >
                                    <Items>
                        ...
                        <ext:GridPanel ID="gridpanel1"  ColumnLines="true" runat="server" PaddingSpec="15 0 0 0">
                            <Store>
                        ...
                        <ext:Toolbar ID="Toolbar4" runat="server" Dock="Bottom">
                            <Items>
                                <ext:Panel ID="Panel3" runat="server" Border="false" ButtonAlign="Center">
                                    <Content>
                                        <asp:Button ID="btnuse" runat="server" Text="使用" OnClick="btnuse_Click" />
                                    </Content>
