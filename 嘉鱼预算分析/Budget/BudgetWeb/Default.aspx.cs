...
public partial class _Default : BudgetBasePage
{
    ...
    protected void GetExNodes4(object sender, NodeLoadEventArgs e)
    {
        ...
        if (UserLimStr == "管理员" || UserLimStr == "审核员")
        {
            Node node5 = new Node();
        ...
        if (UserLimStr == "管理员" || UserLimStr == "局领导" || UserLimStr == "审核员" || UserLimStr == "录入员")
        {
            Node node7 = new Node();
    ...
    protected void GetExNodes5(object sender, NodeLoadEventArgs e)
    {
        ...
        if (UserLimStr == "管理员" || UserLimStr == "审核员" || UserLimStr == "局领导")
        {
            Node node4 = new Node();
        ...
        if (UserLimStr == "管理员" || UserLimStr == "审核员" || UserLimStr == "局领导")
        {
            ...
            node11.NodeID = "NodeBC11";
            node11.Text = "定额设置";
            node11.Href = "WebPage\\BudgetControl\\STQuota.aspx";
            node11.Icon = Icon.PageLink;
            node11.Leaf = true;
            nodes.Add(node11);
        }
    ...
    protected void GetExNodes6(object sender, NodeLoadEventArgs e)
    {
        ...
        if (UserLimStr == "管理员" || UserLimStr == "审核员" || UserLimStr == "录入员")
        {
            Node node10 = new Node();
    ...
    protected void GetExNodes7(object sender, NodeLoadEventArgs e)
    {
        ...
        if (UserLimStr == "管理员" || UserLimStr == "审核员" || UserLimStr == "局领导" || UserLimStr == "查询员")
        {
            Node node3 = new Node();
