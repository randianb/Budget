        ...
        <div id="logobox3">
            ...
            <div class="lform">
                <form id="Form1" action="" method="post" runat="server">
                    <p>
                        <label id="Label1" runat="server">用户名：<asp:TextBox ID="txtUer" runat="server"></asp:TextBox></label></p>
                    <p>
                        <label id="Label2" runat="server">密　码：<asp:TextBox ID="txtPwd" runat="server" TextMode="Password"></asp:TextBox></label></p>
