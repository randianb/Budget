<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OAMonIncomAnaly.aspx.cs" Inherits="WebPage_OptAnaly_OAMonIncomAnaly" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Panel ID="Panel1" runat="server" Height="80" Title="自选分析-选择月度数据" Layout="HBoxLayout">
            <Items>
        ...
        <ext:GridPanel
            ...
            <ColumnModel ID="ColumnModel1" runat="server">
                <Columns>
                    ...
                    <ext:Column ID="Column3" runat="server" Align="Center" Text="本期数" Flex="1" DataIndex="IACkMon" />
                    <ext:Column ID="Column4" runat="server" Align="Center" Text="同期数" Flex="1" DataIndex="TQiackmon" />
                    <ext:Column ID="Column5" runat="server" Align="Center" Text="同期比" Flex="1" DataIndex="TQiRatio" />
                </Columns>
            </ColumnModel>
        </ext:GridPanel>
    </form>
